...
BUILD_SETTINGS = BazelBuildSettings(
    '/fake/tulsi_test_bazel',
    '/private/var/tmp/_bazel_dierksen/b15d2a413bdc389fda12625cb807fd57/sandbox/darwin-sandbox/1/execroot/__main__/_tmp/ef9e16eea4c85f5c32bcbb7c9d7a8e48/_bazel_dierksen/d298fe9b4f58f1c46aea767d34c2192d/execroot/__main__',
    'ios_x86_64',
    {
        'watchos_i386': [
    ...
    set([
        '//tulsi_e2e_swift:Application',
    ]),
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/var/folders/6r/665pbrxd1rzf68f_cfh3cykc008gq4/T/test_tmp_dir.DKvSxH/EndToEndGenerationTests.xctest/Contents/Resources',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            ...
            build = [
                '--apple_generate_dsym',
                '--copt=-fdebug-prefix-map=/private/var/tmp/_bazel_dierksen/b15d2a413bdc389fda12625cb807fd57/sandbox/darwin-sandbox/1/execroot/__main__/_tmp/ef9e16eea4c85f5c32bcbb7c9d7a8e48/_bazel_dierksen/d298fe9b4f58f1c46aea767d34c2192d/execroot/__main__=/private/var/tmp/_bazel_dierksen/b15d2a413bdc389fda12625cb807fd57/sandbox/darwin-sandbox/1/execroot/__main__/_tmp/ef9e16eea4c85f5c32bcbb7c9d7a8e48/fake_execroot/__main__',
            ],
        ),
    ),
    BazelFlagsSet(
